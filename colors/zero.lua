...
-- │ Diff / Git / Plugins        │
-- ╰─────────────────────────────╯
hl("DiffAdd",    { fg = git_colors.green })
hl("DiffChange", { fg = git_colors.blue  })
hl("DiffDelete", { fg = git_colors.red   })
hl("DiffText",   { fg = git_colors.white })

hl("GitSignsAdd",    { fg = git_colors.green })
hl("GitSignsChange", { fg = git_colors.blue  })
hl("GitSignsDelete", { fg = git_colors.red   })

hl("TelescopeBorder", { fg = git_colors.white                })
hl("TelescopePrompt", { fg = git_colors.white, bg = clr.void })
